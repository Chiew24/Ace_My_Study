(() => {
  ...
  function injectSidebarStyle() {
    ...
    style.textContent = `
      ...
      .sidebar-subitem{padding-left:30px!important;overflow:hidden!important;max-height:0!important;min-height:0!important;padding-top:0!important;padding-bottom:0!important;opacity:0!important;transform:translateY(-8px)!important;pointer-events:none!important;transition:max-height .32s ease,padding .32s ease,opacity .24s ease,transform .32s ease!important}
      .sidebar-subject-group.expanded>.sidebar-subitem{max-height:43px!important;min-height:43px!important;padding-top:0!important;padding-bottom:0!important;opacity:1!important;transform:translateY(0)!important;pointer-events:auto!important}
      .sidebar-subject-nav .sidebar-arrow{margin-left:auto;width:14px;height:14px;display:grid;place-items:center;color:currentColor;transition:transform .32s ease}
      ...
      @media (prefers-reduced-motion:reduce){.sidebar-subitem,.sidebar-subject-nav .sidebar-arrow{transition:none!important}}
    `;
