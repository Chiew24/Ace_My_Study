(() => {
  ...
  function injectSidebarStyle() {
    ...
    style.textContent = `
      ...
      .sidebar-subject-nav .sidebar-arrow{margin-left:auto;width:14px;height:14px;display:grid;place-items:center;color:currentColor;transition:transform .3s cubic-bezier(.22,1,.36,1)}
